          ...
          <div className="col-lg-6 d-none d-lg-block">
            <div className="d-inline-flex align-items-center h-100">
              {topMenuItems.map((item, i) => {
                return (
                  <a key={i} className="text-body mr-3" href={item.path}>
                    {item.name}
                  </a>
                );
              })}
          ...
          <div className="col-lg-6 text-center text-lg-right">
            ...
            <div className="d-inline-flex align-items-center d-block d-lg-none">
              <a href="" className="btn px-0 ml-2">
                <FaHeart className="text-dark" size={20} />
                <span className="badge text-dark border border-dark rounded-circle">
                  0
                </span>
              </a>
              <a href="" className="btn px-0 ml-2">
                <FaCartShopping className="text-dark" size={20} />
                <span className="badge text-dark border border-dark rounded-circle">
                  0
                </span>
              </a>
          ...
          <div className="col-lg-3 d-none d-lg-block">
            ...
            >
              <h6 className="text-dark m-0 d-flex align-items-center">
                <FaBars className="mr-2" size={14} />
                Categories
              </h6>
              <FaChevronDown className="text-dark" size={14} />
            </a>
            <nav
